...
$(function(){function t(){setTimeout(function(){$(".carousel-item.active").children().hasClass("js")&&($("#my-slider2").sliderPro("resize"),$(".carousel-item").children().removeClass("js"),console.log("resize"))},650)}$("ul.tabs__ul").on("click","li:not(.active)",function(){$(this).addClass("active").siblings().removeClass("active").closest("div.tabs").find("p.tabs__txt").removeClass("active").eq($(this).index()).addClass("active")}),$("#my-slider").sliderPro({width:325,height:450,arrows:!1,buttons:!1,waitForLayers:!0,fade:!0,autoplay:!1,autoScaleLayers:!1,thumbnailsPosition:"right",thumbnailPointer:!1,thumbnailWidth:70,thumbnailHeight:70,breakpoints:{800:{thumbnailsPosition:"bottom",thumbnailWidth:70,thumbnailHeight:70},500:{thumbnailsPosition:"bottom",thumbnailWidth:70,thumbnailHeight:70}}}),$("#my-slider2").sliderPro({width:325,height:450,arrows:!1,buttons:!1,waitForLayers:!0,fade:!0,autoplay:!1,autoScaleLayers:!1,thumbnailsPosition:"right",thumbnailPointer:!1,thumbnailWidth:70,thumbnailHeight:70}),$(".carousel-control-next").on("click",function(){t()}),$(".video-link").fancybox({padding:0,margin:[30,10,30,10],width:1280,height:720,afterClose:function(){},afterLoad:function(){},helpers:{media:!0},youtube:{autoplay:1,wmode:"opaque",vq:"hd720"},vimeo:{autoplay:0}});var e=$(".team").innerWidth(),i=$(".slider__team"),s=$(".team"),a=s.length,o=4;$(".slider").find("button").on("click",function(){var t=$(this).attr("id");"js-next"==t?(i.css({left:"-="+(e-20)}),o++,$(s[o-1]).css("opacity","1"),$(s[o-5]).css("opacity","0")):"js-prev"==t&&(i.css({left:"+="+(e-20)}),o--,$(s[o-4]).css("opacity","1"),$(s[o]).css("opacity","0")),o>4?$("#js-prev").removeAttr("disabled"):$("#js-prev").attr("disabled","disabled"),o==a?$("#js-next").attr("disabled","disabled"):$("#js-next").removeAttr("disabled")}),function(t,e,i){var s,a=t.getElementsByTagName(e)[0];t.getElementById(i)||(s=t.createElement(e),s.id=i,s.src="//connect.facebook.net/ru_RU/sdk.js#xfbml=1&version=v2.9",a.parentNode.insertBefore(s,a))}(document,"script","facebook-jssdk")});